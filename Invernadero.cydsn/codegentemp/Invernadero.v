// ======================================================================
// Invernadero.v generated from TopDesign.cysch
// 03/13/2019 at 19:01
...
module ADC_DelSig_v3_30_0 (
	...
	cy_clock_v1_0
		#(.id("be0e3cc6-9589-4f4b-825f-3c1f3184cd4f/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("be0e3cc6-9589-4f4b-825f-3c1f3184cd4f/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("335457900.033546"),
		  .is_direct(0),
		  .is_digital(0))
		theACLK
		 (.clock_out(Net_250));
...
// OpAmp_v1_90(Mode=1, Power=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONFIG_TITLE=Opamp, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp, CY_INSTANCE_SHORT_NAME=Opamp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Opamp, )
...
module top ;
	...
	wire [0:0] tmpOE__LM35_In_net;
	wire [0:0] tmpFB_0__LM35_In_net;
	wire [0:0] tmpIO_0__LM35_In_net;
	wire [0:0] tmpINTERRUPT_0__LM35_In_net;
	electrical [0:0] tmpSIOVREF__LM35_In_net;
	...
	cy_psoc3_pins_v1_10
		...
		LM35_In
		 (.oe(tmpOE__LM35_In_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LM35_In_net[0:0]}),
		  .analog({Net_12}),
		  .io({tmpIO_0__LM35_In_net[0:0]}),
		  .siovref(tmpSIOVREF__LM35_In_net),
		  .interrupt({tmpINTERRUPT_0__LM35_In_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LM35_In_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_2 HS05 (
        ...
        .rx_data(Net_37),
        .rx_clk(Net_38));
    defparam HS05.Address1 = 0;
    defparam HS05.Address2 = 0;
    defparam HS05.EnIntRXInterrupt = 0;
    defparam HS05.EnIntTXInterrupt = 0;
    defparam HS05.FlowControl = 0;
    defparam HS05.HalfDuplexEn = 0;
    defparam HS05.HwTXEnSignal = 1;
    defparam HS05.NumDataBits = 8;
    defparam HS05.NumStopBits = 1;
    defparam HS05.ParityType = 0;
    defparam HS05.RXEnable = 1;
    defparam HS05.TXEnable = 1;
	...
	cy_clock_v1_0
		#(.id("477b3464-3658-42ba-9d87-3d086137c0eb"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Cooler2_net;
	wire [0:0] tmpFB_0__Cooler2_net;
	wire [0:0] tmpIO_0__Cooler2_net;
	wire [0:0] tmpINTERRUPT_0__Cooler2_net;
	electrical [0:0] tmpSIOVREF__Cooler2_net;

	cy_psoc3_pins_v1_10
		#(.id("85cec052-40bf-4b23-9447-7d214f2fe61e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Cooler2
		 (.oe(tmpOE__Cooler2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Cooler2_net[0:0]}),
		  .io({tmpIO_0__Cooler2_net[0:0]}),
		  .siovref(tmpSIOVREF__Cooler2_net),
		  .interrupt({tmpINTERRUPT_0__Cooler2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Cooler2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Cooler1_net;
	wire [0:0] tmpFB_0__Cooler1_net;
	wire [0:0] tmpIO_0__Cooler1_net;
	wire [0:0] tmpINTERRUPT_0__Cooler1_net;
	electrical [0:0] tmpSIOVREF__Cooler1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Cooler1
		 (.oe(tmpOE__Cooler1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Cooler1_net[0:0]}),
		  .io({tmpIO_0__Cooler1_net[0:0]}),
		  .siovref(tmpSIOVREF__Cooler1_net),
		  .interrupt({tmpINTERRUPT_0__Cooler1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Cooler1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("b18e5a3b-3832-4f13-9f8f-96b781ef77cf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__MotorA_net;
	wire [0:0] tmpFB_0__MotorA_net;
	wire [0:0] tmpIO_0__MotorA_net;
	wire [0:0] tmpINTERRUPT_0__MotorA_net;
	electrical [0:0] tmpSIOVREF__MotorA_net;

	cy_psoc3_pins_v1_10
		#(.id("cc8f80d6-66a1-4a2e-8cc0-afc453e2c32c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		MotorA
		 (.oe(tmpOE__MotorA_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MotorA_net[0:0]}),
		  .io({tmpIO_0__MotorA_net[0:0]}),
		  .siovref(tmpSIOVREF__MotorA_net),
		  .interrupt({tmpINTERRUPT_0__MotorA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MotorA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MotorB_net;
	wire [0:0] tmpFB_0__MotorB_net;
	wire [0:0] tmpIO_0__MotorB_net;
	wire [0:0] tmpINTERRUPT_0__MotorB_net;
	electrical [0:0] tmpSIOVREF__MotorB_net;

	cy_psoc3_pins_v1_10
		#(.id("0150206b-b0a2-46c3-a34f-e2c3e12dffff"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		MotorB
		 (.oe(tmpOE__MotorB_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MotorB_net[0:0]}),
		  .io({tmpIO_0__MotorB_net[0:0]}),
		  .siovref(tmpSIOVREF__MotorB_net),
		  .interrupt({tmpINTERRUPT_0__MotorB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MotorB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    assign Net_144 = 1'h0;

	wire [0:0] tmpOE__PWMO_net;
	wire [0:0] tmpFB_0__PWMO_net;
	wire [0:0] tmpIO_0__PWMO_net;
	wire [0:0] tmpINTERRUPT_0__PWMO_net;
	electrical [0:0] tmpSIOVREF__PWMO_net;

	cy_psoc3_pins_v1_10
		#(.id("03cf6e32-4bbf-48ee-9ef7-4c789b976443"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PWMO
		 (.oe(tmpOE__PWMO_net),
		  .y({Net_129}),
		  .fb({tmpFB_0__PWMO_net[0:0]}),
		  .io({tmpIO_0__PWMO_net[0:0]}),
		  .siovref(tmpSIOVREF__PWMO_net),
		  .interrupt({tmpINTERRUPT_0__PWMO_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWMO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
